...
function breakStatement(numero) {
  ...
  var arrayNumerosAumentados = [];
  var numeroAumentado = numero;

  for (var i = 0; i < 10; i++) {
    numeroAumentado = numeroAumentado + 2;
    if (numeroAumentado === i) break;
    else {
      arrayNumerosAumentados.push(numeroAumentado);
    }
  }
  if (i < 10) {
    return "Se interrumpió la ejecución"
  }
  else { return arrayNumerosAumentados; }
}
